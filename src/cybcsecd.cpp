...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("CybCSec version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  cybcsecd [options]                     " + "\n" +
                  "  cybcsecd [options] <command> [params]  " + _("Send command to -server or cybcsecd") + "\n" +
                  "  cybcsecd [options] help                " + _("List commands") + "\n" +
                  "  cybcsecd [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "cybcsec:"))
                fCommandLine = true;
...
int main(int argc, char* argv[])
{
    ...
    // Connect cybcsecd signal handlers
    noui_connect();
