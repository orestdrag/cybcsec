#ifndef CYBCSECBRIDGE_H
#define CYBCSECBRIDGE_H
...
class CybCSecBridge : public QObject
{
    Q_OBJECT
...
public:
    explicit CybCSecBridge(CybCSecGUI *window, QObject *parent = 0);
    ~CybCSecBridge();
