...
/**
  CybCSec GUI main class. This class represents the main window of the CybCSec UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class CybCSecGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit CybCSecGUI(QWidget *parent = 0);
    ~CybCSecGUI();
