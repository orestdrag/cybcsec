...
void OptionsModel::Init()
{
    ...
    fAutoRedeemCybCSec = settings.value("fAutoRedeemCybCSec", false).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AutoRedeemCybCSec:
            return fAutoRedeemCybCSec;
        case MinRingSize:
            return nMinRingSize;
        case MaxRingSize:
            return nMaxRingSize;
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemCybCSec: return "AutoRedeemCybCSec";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemCybCSec: {
            fAutoRedeemCybCSec = value.toBool();
            settings.setValue("fAutoRedeemCybCSec", fAutoRedeemCybCSec);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemCybCSec() { return fAutoRedeemCybCSec; }
