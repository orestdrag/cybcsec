...
public:
    ...
    enum StatusCode // Returned by sendCoins
    {
        ...
        SCR_AmountWithFeeExceedsCybCSecBalance,
        SCR_Error,
        SCR_ErrorWithMsg,
        Aborted
    };
    ...
    qint64 getCybCSecBalance() const;
...
signals:
    ...
    void balanceChanged(qint64 balance, qint64 cybcsecBal, qint64 stake, qint64 unconfirmedBalance, qint64 immatureBalance);
